...
export const FEATURE_FLAG_DEFINITIONS: FeatureFlagDefinition[] = [
  ...
  },
  {
    ...
    description:
      "Enable the deterministic MCP review pipeline (discover→quarantine→review→approve). Malicious/forbidden permissions are denied; broadening permissions forces re-review. Code decides, not the model.",
