...
// EndpointCard.tsx — one endpoint row of the APIs tab on the endpoint page: icon,
// title/badge, model count (or loading / "—" placeholder), the endpoint path and a
// copy-full-URL button. Extracted verbatim from EndpointPageClient.tsx
// ("Sub-component: Endpoint Section"); markup, i18n keys and copy ids are unchanged.
