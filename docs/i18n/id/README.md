...
OmniRoute tersedia sebagai image Docker publik di [Docker Hub](https://github.com/LMPrado-DZ23/OmniRoute/pkgs/container/omniroute).
...
- **Pekerja Pelabuhan**: [hub.docker.com/r/diegosouzapw/omniroute](https://github.com/LMPrado-DZ23/OmniRoute/pkgs/container/omniroute)
