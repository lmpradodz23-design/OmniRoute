...
Published `ghcr.io/lmprado-dz23/omniroute:*` images are built for the domain root. You can still
...
docker pull ghcr.io/lmprado-dz23/omniroute:next-web
```
...
```bash
docker pull ghcr.io/lmprado-dz23/omniroute:<stable-version>
docker compose up -d
```
